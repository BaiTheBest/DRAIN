...
class RNN(nn.Module):
    def __init__(self, data_size, device, args):
        ...
        self.lin_transform_down = nn.Sequential(
                            ...
                            nn.ReLU(),
                            nn.Linear(args.hidden_dim, data_size*200+200+200+1))
        # Transforming vector to LSTM input shape
        self.lin_transform_up = nn.Sequential(
                            nn.Linear(data_size*200+200+200+1, args.hidden_dim),
                            nn.ReLU(),
    ...
    def nn_construction(self, E):
        ...
        m_1 = E[:, :self.data_size*200]
        m_2 = E[:, self.data_size*200:(self.data_size*200+200)]
        b_1 = E[:, (self.data_size*200+200):(self.data_size*200+200+200)]
        b_2 = E[:, -1:]
        return [m_1.view(-1, 200), m_2.view(-1, 1)], [b_1.view(-1, 200), b_2]
